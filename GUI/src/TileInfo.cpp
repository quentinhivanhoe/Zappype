...
void Zappy::TileInfo::render(sf::RenderWindow &window)
{
    ...
    this->drawText("TILE " + std::to_string(this->_tile->getIndex().x) + "-" + std::to_string(this->_tile->getIndex().y), {60, 20}, sf::Color::Black, 30, window);
    this->drawText("Food: " + std::to_string(this->_tile->getNItem(Zappy::Item::FOOD)), {10, 70}, sf::Color::Black, 30, window);
    this->drawText("Linemate: " + std::to_string(this->_tile->getNItem(Zappy::Item::LINEMATE)), {10, 110}, sf::Color::Black, 30, window);
    this->drawText("Deraumere: " + std::to_string(this->_tile->getNItem(Zappy::Item::DERAUMERE)), {10, 150}, sf::Color::Black, 30, window);
    this->drawText("Sibur: " + std::to_string(this->_tile->getNItem(Zappy::Item::SIBUR)), {10, 190}, sf::Color::Black, 30, window);
    this->drawText("Mendiane: " + std::to_string(this->_tile->getNItem(Zappy::Item::MENDIANE)), {10, 230}, sf::Color::Black, 30, window);
    this->drawText("Phiras: " + std::to_string(this->_tile->getNItem(Zappy::Item::PHIRAS)), {10, 270}, sf::Color::Black, 30, window);
    this->drawText("Thystane: " + std::to_string(this->_tile->getNItem(Zappy::Item::THYSTAME)), {10, 310}, sf::Color::Black, 30, window);
    this->drawText("TRANTORIANS ", {40, 365}, sf::Color::Black, 30, window);
    for (auto button: this->_buttons)
